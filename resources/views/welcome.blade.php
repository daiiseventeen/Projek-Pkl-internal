                ...
                <div class="container-fluid">
                    ...
                    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar">
                        ...
                        <div class="offcanvas-body d-flex align-items-center justify-content-between">
                            <select class="form-select w-auto me-4">
                            ...
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0 d-flex gap-3">
                                <li class="nav-item"><a class="nav-link active" href="#">Women</a></li>
                        ...
                        <div class="swiper-wrapper">
                            @foreach ($categories as $cat)
                                <a href="#" class="nav-link category-item swiper-slide">
                                    <img src="{{ asset('images/' . ($cat->icon ?? 'icon-vegetables-broccoli.png')) }}"
        ...
        <div class="container-fluid">
            <div class="row mb-4">
                <div class="col-12 d-flex justify-content-between align-items-center">
                    <h4 class="product-title mb-0">Produk</h4>
                </div>
            </div>
            <div class="row g-4">
                    ...
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2">
                        <div class="card h-100 shadow-sm border-0">
                            <div class="position-relative">
                                <a href="{{ url('/product/item') }}"
                                    class="btn-wishlist position-absolute top-0 end-0 m-2 z-1 bg-white rounded-circle p-1">
                                    <svg width="17" height="17">
                                        <use xlink:href="#heart"></use>
                                    </svg>
                                </a>
                                <a href="{{ url('/product/item') }}" title="{{ $item->name }}">
                            ...
                            <div class="card-body d-flex flex-column">
                                ...
                                <div class="mb-2 text-muted small">
                                    {{ $item->category->nama ?? 'Kategori' }} &bull; Stok: {{ $item->stok }}
                                </div>
                                <div class="mb-2 fw-bold text-primary">
                                    Rp {{ number_format($item->harga, 0, ',', '.') }}
                                </div>
                                <form action="{{ route('order.create') }}" method="POST" class="mt-auto">
                                    @csrf
    ...
    <section class="py-5 my-5">
        <div class="container-fluid">
            <div class="bg-warning py-5 rounded-5"
                style="background-image: url('{{ asset('images/bg-pattern-2.png') }}') no-repeat;">
                <div class="container">
                    <div class="row">
                        <div class="col-md-4">
